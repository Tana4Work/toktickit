...
describe("Lab 2 Ticket Detail", () => {
    ...
    it("shows read-only ticket data and returns to My Tickets", async () => {
        ...
        const onBack = vi.fn();
        render(_jsx(RequesterProvider, { children: _jsx(DetailHarness, { onBack: onBack }) }));
    ...
    it("uploads a valid attachment from Ticket Detail", async () => {
        ...
        render(_jsx(RequesterProvider, { children: _jsx(DetailHarness, { onBack: vi.fn() }) }));
