...
export default function App() {
    ...
    const [activePage, setActivePage] = useState(getStoredUser()?.role === "ITStaff" || getStoredUser()?.role === "Administrator" ? "queue" : "tickets");
    ...
    function handleAuthenticated(authUser) { setUser(authUser); selectRequester(authUser); setSelectedTicketId(null); setActivePage(authUser.role === "ITStaff" || authUser.role === "Administrator" ? "queue" : "tickets"); }
